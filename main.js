  ...
  const copy = {
    "zh-CN": {
      ...
      download: {
        ...
        commandCta: "命令行下载",
        commandTitle: "从命令行安装",
        commandBody: "安装脚本从 master 加载，并默认解析最新稳定版；如需指定版本，在命令后追加 release tag。",
        backHome: "返回首页",
        groups: [
          ["macOS / Linux · 最新稳定版", "curl -fsSL https://raw.githubusercontent.com/DuGuYifei/Aflow/master/install/install.sh | bash"],
          ["macOS / Linux · 指定版本", "curl -fsSL https://raw.githubusercontent.com/DuGuYifei/Aflow/master/install/install.sh | bash -s -- v0.0.1-beta.2"],
          ["Windows PowerShell · 最新稳定版", "& ([scriptblock]::Create((irm \"https://raw.githubusercontent.com/DuGuYifei/Aflow/master/install/install.ps1\")))"],
          ["Windows PowerShell · 指定版本", "& ([scriptblock]::Create((irm \"https://raw.githubusercontent.com/DuGuYifei/Aflow/master/install/install.ps1\"))) \"v0.0.1-beta.2\""],
        ],
      },
      docs: {
        title: "文档",
    ...
    "en-US": {
      ...
      download: {
        ...
        commandBody: "The installer is loaded from master and resolves the latest stable release by default. Pass a release tag when you want a specific version.",
        backHome: "Back home",
        groups: [
          ["macOS / Linux · latest stable", "curl -fsSL https://raw.githubusercontent.com/DuGuYifei/Aflow/master/install/install.sh | bash"],
          ["macOS / Linux · specific version", "curl -fsSL https://raw.githubusercontent.com/DuGuYifei/Aflow/master/install/install.sh | bash -s -- v0.0.1-beta.2"],
          ["Windows PowerShell · latest stable", "& ([scriptblock]::Create((irm \"https://raw.githubusercontent.com/DuGuYifei/Aflow/master/install/install.ps1\")))"],
          ["Windows PowerShell · specific version", "& ([scriptblock]::Create((irm \"https://raw.githubusercontent.com/DuGuYifei/Aflow/master/install/install.ps1\"))) \"v0.0.1-beta.2\""],
        ],
      },
      docs: {
        title: "Docs",
