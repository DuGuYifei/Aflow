...
export interface NativeResumeAgentServer {
  id: string;
  settings: {
    type: "custom" | "registry" | "headless";
    registryId?: string;
  };
}
...
export interface NativeResumeInput {
  agentServer?: NativeResumeAgentServer;
...
function registryIdForAgentServer(agentServer: NativeResumeAgentServer | undefined): string | undefined {
